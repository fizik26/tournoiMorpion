...
//                JLabel casE = new JLabel();
    ...
    // nous avons besoin de passer les deux joueurs pour conna�tre la couleur et le signe de chaque joueur lorsque nous rafraichissons la grille
...
//                JLabel casE = new JLabel();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // si le signe du joueur qui a cliqu� est X ( donc comme le signe de la case ), alors on assigne sa couleur au X
                // sinon , on assigne la couleur de l'autre joueur car �a voudra dire que c'est l'autre joueur qui a le signe X et donc qui a pr�c�demment cliqu� sur cette case o� il y a le X
                ...
                // si le signe du joueur qui a cliqu� est O ( donc comme le signe de la case ), alors on assigne sa couleur au O
                // sinon , on assigne la couleur de l'autre joueur car �a voudra dire que c'est l'autre joueur qui a le signe O et donc qui a pr�c�demment cliqu� sur cette case o� il y a le O
